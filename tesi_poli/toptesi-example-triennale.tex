...
\begin{ThesisTitlePage}
    ...
    \corsodistudi{Astronomia Applicata}
    \candidato{Galileo \textsc{Galilei}}
    %\TitoloListaCandidati{}
    %\candidato{Galileo \textsc{Galilei}}[123456]
    %\candidata{Maria \textsc{Rossi}}
    %\secondacandidata{Giovanna \textsc{Bianchi}}
    %\terzocandidato{Evangelista \textsc{Torricelli}}
    \relatore{prof.~Albert \textsc{Einstein}}
    \secondorelatore{dipl.~ing.~Werner \textsc{von Braun}}
    \tutoreaziendale{dott.\ ing.\ Giovanni \textsc{Giacosa}}
    \NomeTutoreAziendale{Supervisore aziendale\\Centro Ricerche FIAT}
    \sedutadilaurea{\textsc{Anno~accademico} 1615-1616}
    \logosede{logotre}
    \retrofrontespizio{\luogo{Marconia}\giorno{}\parindent=0pt
    Questo lavoro è soggetto alla Creative Commons Licence.\medskip
    
    Dichiaro sotto la mia personale responsabilità di avere 
    rispettato tutte le leggi relative alla proprietà intellettuale 
    e di copyright di tutti i brani citati.}
