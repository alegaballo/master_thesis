...
\english
\CorsoDiLaureaIn{\Large Master's Thesis}
...
%%%%%%% Corso degli studi
\corsodilaurea{in Computer Enginerring}% per la laurea
%%%%%%% L'eventuale numero di matricola va fra parentesi quadre
\candidato{\tabular{@{}l@{}}Alessandro \textsc{Gaballo}\endtabular}% per tutti i percorsi
